...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 4. Caso as credenciais estejam incorretas
    } else {
...
<body>
    ...
    <!-- Exibição condicional: Card de Boas-Vindas ou Formulário de Login -->
    ...
    <?php if ($sucesso): ?>
        ...
        <div style="border: 2px solid green; padding: 15px; background-color: #e6ffe6; border-radius: 5px;">
            ...
            <h3>
                Bem-vindo, <?= htmlspecialchars($email) ?>!
            </h3>

            <p>
                Autenticação realizada com sucesso no painel administrativo.
            </p>
    ...
    <?php else: ?>
        ...
        <form action="" method="POST">
            ...
            <!-- A senha não é preenchida novamente por segurança -->
            <input
                type="password"
                id="senha"
                name="senha"
